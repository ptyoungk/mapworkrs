...
function getConnection() {
	...
	global $db_mapworkrs_db_Url, $db_mapworkrs_db_User, $db_mapworkrs_db_Pass, $db_mapworkrs_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_mapworkrs_db_Url.";dbname=".$db_mapworkrs_db_DbName, $db_mapworkrs_db_User, $db_mapworkrs_db_Pass);
